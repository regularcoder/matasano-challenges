#http://cryptopals.com/sets/1/challenges/4/ (Detect single-character XOR)

#Place 4.txt from http://cryptopals.com/static/challenge-data/4.txt in same folder
...
#Attempt to look for a XOR encoded string in a file
